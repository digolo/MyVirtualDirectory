 ...
 *  
 */
package net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.examples;


import java.nio.ByteBuffer;

import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.EncoderException;
import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.EncoderCallback;
import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.EncoderMonitor;
import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.EncoderMonitorAdapter;
import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.StatefulEncoder;
...
public class HexEncoder implements StatefulEncoder
{
     ...
     * 
     * @param obj
     * @throws net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.EncoderException
     */
