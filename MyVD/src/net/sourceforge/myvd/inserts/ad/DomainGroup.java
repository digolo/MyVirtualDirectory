...
public class DomainGroup implements Insert {
	...
	public void configure(String name, Properties props, NameSpace nameSpace)
		...
		this.name = name;
		this.domainUsersGroupDN = new DN(props.getProperty("dn"));
	...
	public void postSearchEntry(PostSearchEntryInterceptorChain chain,
		...
		if (new DN(entry.getEntry().getDN()).equals(this.domainUsersGroupDN)) {
			LDAPAttribute attrib = new LDAPAttribute("memberUrl",this.url);
