...
import net.sourceforge.myvd.protocol.ldap.mina.asn1.ber.grammar.IAction;
...
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.AttributeDescAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ControlValueAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ControlsInitAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ErrorMessageAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitAndFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitApproxMatchFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitAssertionValueFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitAttributeDescFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitAttributeDescListAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitEqualityMatchFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitExtensibleMatchFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitGreaterOrEqualFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitLessOrEqualFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitNotFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitOrFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitPresentFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitReferralsAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.InitSubstringsFilterAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.MatchedDNAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ModifyAttributeValueAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ReferralAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ResponseAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ResponseNameAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ResultCodeAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.SearchResultAttributeValueAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ServerSASLCredsAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.StoreAnyAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.StoreFinalAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.StoreMatchValueAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.StoreReferenceAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.StoreTypeMatchingRuleAction;
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.actions.ValueAction;
...
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.unbind.UnBindRequest;
...
import net.sourceforge.myvd.protocol.ldap.mina.ldap.name.Rdn;
        ...
        super.transitions[LdapStatesEnum.SUBSTRINGS_STATE][LdapConstants.SUBSTRINGS_FILTER_INITIAL_TAG] = 
                ...
                new GrammarAction( "Store substring filter initial Value" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
                    ...
                    node.setValue(new String( tlv.getValue().getData() ) + "*");
        ...
        super.transitions[LdapStatesEnum.MATCH_VALUE_STATE][LdapConstants.DN_ATTRIBUTES_FILTER_TAG] = 
                ...
                "Store matching dnAttributes Value" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
                    ...
                    // Store the value.
                    ExtensibleMatchFilter extensibleMatchFilter = null;/*( ExtensibleMatchFilter ) searchRequest
                        .getTerminalFilter();*/
