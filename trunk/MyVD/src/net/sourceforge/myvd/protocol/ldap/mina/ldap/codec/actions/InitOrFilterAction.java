...
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.search.OrFilter;
...
public class InitOrFilterAction extends GrammarAction
{
    ...
    public void action( IAsn1Container container ) throws DecoderException
    {
        ...
        //Filter orFilter = new OrFilter( ldapMessageContainer.getMessageId() );

        FilterNode node = new FilterNode(FilterType.OR,new ArrayList<FilterNode>());
