...
import net.sourceforge.myvd.protocol.ldap.mina.ldap.codec.search.NotFilter;
...
public class InitNotFilterAction extends GrammarAction
{
    ...
    public void action( IAsn1Container container ) throws DecoderException
    {
        ...
        //Filter notFilter = new NotFilter( ldapMessageContainer.getMessageId() );

        FilterNode node = new FilterNode(FilterType.NOT,null);
