...
public class CompareInterceptorChain extends InterceptorChain {
	...
	public void nextCompare(DistinguishedName dn,Attribute attrib,LDAPConstraints constraints) throws LDAPException {
		Insert next = this.getNext();
		if (next != null) {
			next.compare(this,dn,attrib,constraints);
		} else {
			if (router != null) {
				router.compare(this,dn,attrib,constraints);
			}
		}
	}
