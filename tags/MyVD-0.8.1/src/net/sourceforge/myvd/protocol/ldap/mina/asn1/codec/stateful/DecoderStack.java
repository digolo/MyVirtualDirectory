 ...
 *  
 */
package net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful;
...
public class DecoderStack extends AbstractStatefulDecoder
{
     ...
     * 
     * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.StatefulDecoder#
    ...
    class ChainingCallback implements DecoderCallback
    {
         ...
         * 
         * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.DecoderCallback#decodeOccurred
         *      (net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.stateful.StatefulDecoder,
         *      java.lang.Object)
         */
        public void decodeOccurred( StatefulDecoder decoder, Object decoded )
        {
