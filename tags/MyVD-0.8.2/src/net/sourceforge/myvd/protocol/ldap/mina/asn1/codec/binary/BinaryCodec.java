...
package net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.binary;


import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.BinaryDecoder;
import net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.BinaryEncoder;
...
public class BinaryCodec implements BinaryDecoder, BinaryEncoder
{
     ...
     * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.BinaryEncoder#encode(byte[])
     */
     ...
     * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.Encoder#encode(java.lang.Object)
     */
     ...
     * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.Decoder#decode(java.lang.Object)
     */
     ...
     * @return the raw encoded binary where each bit corresponds to a byte in
     *         the byte array argument
     * @see net.sourceforge.myvd.protocol.ldap.mina.asn1.codec.Decoder#decode(Object)
     */
